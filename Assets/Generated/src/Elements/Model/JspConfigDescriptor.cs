...
namespace Elements.Model
{
    ...
    public partial class JspConfigDescriptor
    {
        ...
        public JspConfigDescriptor(List<JspPropertyGroupDescriptor> jspPropertyGroups = default(List<JspPropertyGroupDescriptor>), List<TaglibDescriptor> taglibs = default(List<TaglibDescriptor>))
        {
