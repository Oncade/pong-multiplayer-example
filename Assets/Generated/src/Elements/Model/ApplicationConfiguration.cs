...
namespace Elements.Model
{
    ...
    public partial class ApplicationConfiguration
    {
        ...
        public ApplicationConfiguration(string id = default(string), CategoryEnum category = default(CategoryEnum), string uniqueIdentifier = default(string), Application parent = default(Application), List<ProductBundle> productBundles = default(List<ProductBundle>))
        {
