...
namespace Elements.Model
{
    ...
    public partial class UserCreateResponse
    {
        ...
        public UserCreateResponse(string id = default(string), string name = default(string), string email = default(string), string firstName = default(string), string lastName = default(string), LevelEnum? level = default(LevelEnum?), bool active = default(bool), string facebookId = default(string), string firebaseId = default(string), string appleSignInId = default(string), string primaryPhoneNb = default(string), List<Profile> profiles = default(List<Profile>), string password = default(string))
        {
            this.Id = id;
            this.Name = name;
            this.Email = email;
