...
namespace Elements.Model
{
    ...
    public partial class ServletContext
    {
        ...
        public ServletContext(ServletContextClassLoader classLoader = default(ServletContextClassLoader), int majorVersion = default(int), int minorVersion = default(int), string contextPath = default(string), string serverInfo = default(string), Object attributeNames = default(Object), int effectiveMajorVersion = default(int), string servletContextName = default(string), Dictionary<string, ServletRegistration> servletRegistrations = default(Dictionary<string, ServletRegistration>), Dictionary<string, FilterRegistration> filterRegistrations = default(Dictionary<string, FilterRegistration>), SessionCookieConfig sessionCookieConfig = default(SessionCookieConfig), List<SessionTrackingModesEnum> sessionTrackingModes = default(List<SessionTrackingModesEnum>), List<EffectiveSessionTrackingModesEnum> effectiveSessionTrackingModes = default(List<EffectiveSessionTrackingModesEnum>), JspConfigDescriptor jspConfigDescriptor = default(JspConfigDescriptor), string virtualServerName = default(string), int sessionTimeout = default(int), string requestCharacterEncoding = default(string), List<DefaultSessionTrackingModesEnum> defaultSessionTrackingModes = default(List<DefaultSessionTrackingModesEnum>), int effectiveMinorVersion = default(int), Object initParameterNames = default(Object), string responseCharacterEncoding = default(string))
        {
