...
namespace Elements.Model
{
    ...
    public partial class ServletContext
    {
        ...
        public ServletContext(ServletContextClassLoader classLoader = default(ServletContextClassLoader), int majorVersion = default(int), int minorVersion = default(int), int effectiveMajorVersion = default(int), int effectiveMinorVersion = default(int), Dictionary<string, ServletRegistration> servletRegistrations = default(Dictionary<string, ServletRegistration>), List<SessionTrackingModesEnum> sessionTrackingModes = default(List<SessionTrackingModesEnum>), List<DefaultSessionTrackingModesEnum> defaultSessionTrackingModes = default(List<DefaultSessionTrackingModesEnum>), string requestCharacterEncoding = default(string), string responseCharacterEncoding = default(string), List<EffectiveSessionTrackingModesEnum> effectiveSessionTrackingModes = default(List<EffectiveSessionTrackingModesEnum>), Object initParameterNames = default(Object), string servletContextName = default(string), Dictionary<string, FilterRegistration> filterRegistrations = default(Dictionary<string, FilterRegistration>), SessionCookieConfig sessionCookieConfig = default(SessionCookieConfig), JspConfigDescriptor jspConfigDescriptor = default(JspConfigDescriptor), string virtualServerName = default(string), int sessionTimeout = default(int), Object attributeNames = default(Object), string contextPath = default(string), string serverInfo = default(string))
        {
