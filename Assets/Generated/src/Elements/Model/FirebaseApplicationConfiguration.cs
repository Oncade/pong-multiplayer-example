...
namespace Elements.Model
{
    ...
    public partial class FirebaseApplicationConfiguration
    {
        ...
        public FirebaseApplicationConfiguration(string id = default(string), CategoryEnum category = default(CategoryEnum), string uniqueIdentifier = default(string), Application parent = default(Application), List<ProductBundle> productBundles = default(List<ProductBundle>), string projectId = default(string), string serviceAccountCredentials = default(string))
        {
