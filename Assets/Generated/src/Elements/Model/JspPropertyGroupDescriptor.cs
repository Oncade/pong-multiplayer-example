...
namespace Elements.Model
{
    ...
    public partial class JspPropertyGroupDescriptor
    {
        ...
        public JspPropertyGroupDescriptor(string buffer = default(string), string deferredSyntaxAllowedAsLiteral = default(string), string trimDirectiveWhitespaces = default(string), string errorOnUndeclaredNamespace = default(string), string errorOnELNotFound = default(string), string pageEncoding = default(string), string scriptingInvalid = default(string), List<string> includePreludes = default(List<string>), List<string> includeCodas = default(List<string>), string defaultContentType = default(string), List<string> urlPatterns = default(List<string>), string elIgnored = default(string), string isXml = default(string))
        {
            this.Buffer = buffer;
