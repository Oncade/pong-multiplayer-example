...
namespace Elements.Model
{
    ...
    public partial class FacebookApplicationConfiguration
    {
        ...
        public FacebookApplicationConfiguration(string id = default(string), CategoryEnum category = default(CategoryEnum), string uniqueIdentifier = default(string), Application parent = default(Application), List<ProductBundle> productBundles = default(List<ProductBundle>), string applicationId = default(string), string applicationSecret = default(string), List<string> builtinApplicationPermissions = default(List<string>))
        {
