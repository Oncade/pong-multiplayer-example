...
namespace Elements.Model
{
    ...
    public partial class SessionCookieConfig
    {
        ...
        public SessionCookieConfig(string path = default(string), int maxAge = default(int), string domain = default(string), string name = default(string), Dictionary<string, string> attributes = default(Dictionary<string, string>), string comment = default(string), bool httpOnly = default(bool), bool secure = default(bool))
        {
            this.Path = path;
            this.MaxAge = maxAge;
            this.Domain = domain;
