...
namespace Elements.Model
{
    ...
    public partial class GooglePlayApplicationConfiguration
    {
        ...
        public GooglePlayApplicationConfiguration(string id = default(string), CategoryEnum category = default(CategoryEnum), string uniqueIdentifier = default(string), Application parent = default(Application), List<ProductBundle> productBundles = default(List<ProductBundle>), string applicationId = default(string), Dictionary<string, Object> jsonKey = default(Dictionary<string, Object>))
        {
